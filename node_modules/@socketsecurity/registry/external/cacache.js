...
function requirePath() {
  ...
  function contentPath(cache, integrity) {
    ...
    return path$1.join(contentDir(cache), sri.algorithm, ...hashToSegments(sri.hexDigest()));
  }
...
function requireCommonjs$1() {
   ...
   */
  commonjs.PathScurry = process.platform === 'win32' ? PathScurryWin32 : process.platform === 'darwin' ? PathScurryDarwin : PathScurryPosix;
  return commonjs;
}
...
var hasRequiredLib;
function requireLib() {
  if (hasRequiredLib) return lib$5.exports;
  hasRequiredLib = 1;
  (function (module) {
